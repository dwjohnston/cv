...
$(document).ready(function () {
  ...
  var svg = d3.select("#d3").append("svg").attr("width", 300).attr("height", 200);

  svg.selectAll(".bar").data(data).enter().append("rect").attr("class", "bar").attr("width", function (d) {
    return d;
  }).attr("height", "40").attr("y", function (d, i) {
    return i * 50 + 10;
  }).attr("x", "10");
});
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./node_modules/css-loader/index.js!./a4.css", function() {
			var newContent = require("!!./node_modules/css-loader/index.js!./a4.css");
